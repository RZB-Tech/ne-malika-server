...
Проверь карточку товара по 3 критериям и верни строго структурированный JSON и не обращай внимания на цену:

1. description — полнота и читаемость описания, отсутствие спама или запрещённого контента.
2. photos — действительно ли на фото виден заявленный товар, приемлемое качество, отсутствие постороннего/неприемлемого контента.
3. photoMatch — соответствуют ли фото описанию и наоборот (модель, состояние, комплектация).
