...
export class ProductStatsDto {
  ...
  /**
   * Сумма уникальных по дням, а не уникальные за период: один человек, заходивший
   * трижды в разные дни, посчитан трижды. Хранить настоящую уникальность за
   * произвольный отрезок можно только журналом посетителей, от которого таблица
   * и уходит. Названо «посещениями», чтобы не выдавать одно за другое.
   */
  @ApiProperty({
